    ...
    <div>
      ...
      >
        ...
        <p className="text-sm leading-relaxed mt-6">
          ...
          used in our coats and jackets is always made from recycled polyester.
          <br />
          We recognize that using recycled polyester is not without challenges.
          We are aware that microplastics may be released during production,
          use, and washing processes. Additionally, recycling polyester back to
          clothing comes with difficulty. We are continuously searching for
          alternatives to polyester, but for some products, its unique
          characteristics still remain essential to the product for the moment.
        </p>
