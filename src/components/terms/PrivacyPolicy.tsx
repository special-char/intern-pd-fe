        ...
        <div className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            <section id="introduction" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">1. Introduction</h2>
              ...
              <p><strong>What is the general privacy policy of Rino & Pelle?</strong><br />
            ...
            <section id="security" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">2. Security</h2>
            ...
            <section id="data-collection" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">3. Data Collection</h2>
            ...
            <section id="cookies" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">4. Cookie use</h2>
            ...
            <section id="data-sharing" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">5. Sharing your data</h2>
            ...
            <section id="user-rights" className="mb-12">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">6. The right of inspection, correction or removal</h2>
